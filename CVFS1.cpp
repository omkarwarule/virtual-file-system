...
void man(char *name)
{
    ...
    {
        printf("Description : Used to list all inforamation of files \n");
        printf("Usage       : ls\n");
    }
...
int LseekFile(int fd, int size, int from)
{
    ...
    if((UFDTArr->ptrfiletable->mode == READ) || (UFDTArr->ptrfiletable->mode == READ+WRITE))
    {
        if(from == CURRENT)
        {
    ...
    else if((UFDTArr->ptrfiletable->mode == WRITE))
    {
        if(from == CURRENT)
        {
...
int main()
{
    cout<<"--------------Welcome to omkar's application of Customised virtual file system--------------- \n";
